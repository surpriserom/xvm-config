 ...
 */
{
  "rangeCircle": { "enabled": true, "thickness": 0.75, "alpha": 80, "color": "0xEE4444" },
    ...
    "circles": {
        ...
        "view": [
            // Main circles:
            { "enabled":  true, "distance": "blindarea", "scale": 1, "thickness": 0.5, "alpha": 80, "color": "0x3C3C3C" },
            ...
            { "enabled": true, "distance": "dynamic",   "scale": 1, "thickness":  0.5, "alpha": 60, "color": "0x00D4FF" }
        ],
